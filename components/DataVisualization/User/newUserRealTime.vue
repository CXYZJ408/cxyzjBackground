        ...
        userRegisterRealTime: {
          ...
          tooltip: {
            ...
            formatter: function (params) {
              ...
              return '时间：' + date.getFullYear() + '/' + (date.getMonth() + 1) + '/' + date.getDate() + ' ' + (date.getHours() >= 10 ? date.getHours() : '0' + date.getHours()) + ':' + (date.getMinutes() >= 10 ? date.getMinutes() : '0' + date.getMinutes()) + '<br/>注册人数 : ' + params.value[1]
            },
            axisPointer: {
              type: 'none',
              animation: false
